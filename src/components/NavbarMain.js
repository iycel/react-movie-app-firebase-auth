                    ...
                    <div className="d-flex justify-content-end align-items-center p-2">
                        {
                            currentUser ? (
                                <div className="dropdown mx-2">
                                    <button className="btn btn-outline-secondary btn-sm dropdown-toggle " type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style={{ padding: '10px' }}>
                                        <span className='fw-bold text-dark'>{currentUser?.displayName}</span>
                                    </button>
                                    <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <Link className="dropdown-item" to={'/login'} onClick={() => logOut()}>Logout</Link>
